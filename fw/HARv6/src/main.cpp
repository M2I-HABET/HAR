/*
   ...
   Main program to be run on version 6.0 of HABET's High Altitude Reporter (HAR).
...
void loop() {
  ...
  char output[256];
  sprintf(output, "$$HAR, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %.2f", GPSLat, GPSLon, GPSAlt, GPSHeading, GPSSpeed, GPSPDOP, counter,volt);
